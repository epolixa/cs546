...
//if (login_check($mysqli)) {
    if($step=="createFlight" || $step=="editFlight") {
        ...
        echo '<form id = "flights_id" action = "admin.php?step='.$nextStep.'Flight" method = "POST">';
        ...
        if (isset($_POST['airline_name']) && isset($_POST['flight_number']) && isset($_POST['origin']) && isset($_POST['destination']) && isset($_POST['arrival_time']) && isset($_POST['departure_time']) && isset($_POST['status'])) {
            if($flight->edit($_POST['flight_number'],$_POST['airline_name'],$_POST['destination'], $_POST['departure_time'], $_POST['arrival_time'], $_POST['status'],$_POST['origin'])){
                ...
                echo"There was an error with your submission. <a href=admin.php?step=editFlight&flight_id=".$flight_id.">Back</a>";
            }
        }
       ...
       if($flight->delete()){
        ...
        echo'Admin Home Page<br>
        <a href="admin.php?step=createFlight">Create Flight</a><br>
        <a href="admin.php?step=editFlight&flight_number=123">Edit Flight with an ID of 123</a><br>
        <a href="admin.php?step=deleteFlight&flight_number=123">Delete Flight with an ID of 123</a>';
